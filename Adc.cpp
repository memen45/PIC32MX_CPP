...
scan_autoirq (ASINT e) -> void
            {
            clrbit(ADC1CON5, ASINT_MASK<<ASINT_SHIFT);
            setbit(ADC1CON5, e<<ASINT_SHIFT);
            }
...
write_mode  (WM e) -> void
            {
            clrbit(ADC1CON5, WM_MASK<<WM_SHIFT);
            setbit(ADC1CON5, e<<WM_SHIFT);
            }
...
compare_mode (CM e) -> void
            {
            clrbit(ADC1CON5, CM_MASK<<CM_SHIFT);
            setbit(ADC1CON5, e<<CM_SHIFT);
            }
