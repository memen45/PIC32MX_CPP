...
void Pins::digital_in(void){ Reg::set(m_pt+TRIS, m_pn); Reg::clr(m_pt, m_pn); }
void Pins::analog_in(void){ Reg::set(m_pt+TRIS, m_pn); Reg::set(m_pt, m_pn); }
void Pins::digital_out(void){ Reg::clr(m_pt+TRIS, m_pn); Reg::clr(m_pt, m_pn); }
